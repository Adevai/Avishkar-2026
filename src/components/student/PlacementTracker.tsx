                ...
                <div
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <button
                      onClick={async () => {
                        try {
                          const blob = await api.getInterviewSlotIcs(slot.id);
                          ...
                          setNotification(e?.message || 'Could not download the calendar invite.');
                        }
                      }}
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 rounded-xl font-bold text-[11px] transition-colors"
                      title="Download the calendar invite (.ics) — works with Google Calendar, Outlook and Apple Calendar"
                    >
